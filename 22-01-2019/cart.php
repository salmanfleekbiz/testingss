	...
	<section class="_full_cart_content">
		...
		<div class="container">
			...
			<?php endif; ?>
				...
				<a href="javascript:;" id="paypal-click" data-course="<?= $items['name']?>" data-price="<?= $items['subtotal']?>" data-cat="<?= $items['cat_name']?>" class="_btn_checkout_paypal btn_cart_checkout">
...
<?php endif; ?>
 ...
 $(document).on("click","#paypal-click",function() {
      ...
      $.ajax({
		  ...
		  data: {course: course,price: price,discount: discount,course_cat:course_cat} ,
